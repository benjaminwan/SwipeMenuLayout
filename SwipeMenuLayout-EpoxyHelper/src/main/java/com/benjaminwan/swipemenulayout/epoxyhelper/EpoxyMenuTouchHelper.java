package com.benjaminwan.swipemenulayout.epoxyhelper;
...
import com.benjaminwan.swipemenulayout.epoxyhelper.EpoxyMenuModelTouchCallback;
import com.benjaminwan.swipemenulayout.helper.MenuItemTouchHelper;
import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;
import static com.benjaminwan.swipemenulayout.helper.MenuItemTouchHelper.Callback.makeMovementFlags;
 ...
 * MenuItemTouchHelper}. That class provides an interface that makes it easier to work with Epoxy models
 ...
 */
public abstract class EpoxyMenuTouchHelper {
    ...
    public static class DragBuilder {
         ...
         * MenuItemTouchHelper} will be created and configured for you, and
    ...
    public static class DragBuilder2 {
        ...
        public DragBuilder3 forVerticalList() {
            return withDirections(MenuItemTouchHelper.UP | MenuItemTouchHelper.DOWN);
        }
        ...
        public DragBuilder3 forHorizontalList() {
            return withDirections(MenuItemTouchHelper.LEFT | MenuItemTouchHelper.RIGHT);
        }
        ...
        public DragBuilder3 forGrid() {
            return withDirections(MenuItemTouchHelper.UP | MenuItemTouchHelper.DOWN | MenuItemTouchHelper.LEFT
                    | MenuItemTouchHelper.RIGHT);
        }

        /**
         * Set custom movement flags to dictate which drag directions should be allowed.
         * <p>
         * Can be any of {@link MenuItemTouchHelper#LEFT}, {@link MenuItemTouchHelper#RIGHT}, {@link
         * MenuItemTouchHelper#UP}, {@link MenuItemTouchHelper#DOWN}, {@link MenuItemTouchHelper#START}, {@link
         * MenuItemTouchHelper#END}
         * <p>
    ...
    public static class DragBuilder4<U extends EpoxyModel> {
         ...
         *
         * @return An {@link MenuItemTouchHelper} instance that has been initialized and attached to a
         ...
         * events via setting null on {@link MenuItemTouchHelper#attachToRecyclerView(RecyclerView)}
         */
        public MenuItemTouchHelper andCallbacks(final DragCallbacks<U> callbacks) {
            MenuItemTouchHelper itemTouchHelper =
                    new MenuItemTouchHelper(new EpoxyMenuModelTouchCallback<U>(controller, targetModelClass) {
    ...
    public static class SwipeBuilder {
        ...
        public SwipeBuilder2 right() {
            return withDirections(MenuItemTouchHelper.RIGHT);
        }
        ...
        public SwipeBuilder2 left() {
            return withDirections(MenuItemTouchHelper.LEFT);
        }
    ...
    public static class SwipeBuilder3<U extends EpoxyModel> {
         ...
         * events via setting null on {@link MenuItemTouchHelper#attachToRecyclerView(RecyclerView)}
         */
        public MenuItemTouchHelper andCallbacks(final SwipeCallbacks<U> callbacks) {
            MenuItemTouchHelper itemTouchHelper =
                    new MenuItemTouchHelper(new EpoxyMenuModelTouchCallback<U>(null, targetModelClass) {
