...
import com.benjaminwan.swipemenulayout.epoxyhelper.EpoxyMenuTouchHelperCallback;

/**
 * A wrapper around {@link ItemTouchHelper.Callback} to enable
 ...
 */
public abstract class EpoxyMenuModelTouchCallback<T extends EpoxyModel>
    extends EpoxyMenuTouchHelperCallback implements EpoxyDragCallback<T>, EpoxySwipeCallback<T> {
  ...
  public EpoxyMenuModelTouchCallback(@Nullable EpoxyController controller, Class<T> targetModelClass) {
