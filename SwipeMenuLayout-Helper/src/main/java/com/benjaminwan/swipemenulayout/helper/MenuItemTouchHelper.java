...
package com.benjaminwan.swipemenulayout.helper;
 ...
 */
public class MenuItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    private final OnItemTouchListener mOnItemTouchListener = new OnItemTouchListener() {
        ...
        public boolean onInterceptTouchEvent(@NonNull RecyclerView recyclerView,
            ...
            WeakReference<SwipeMenuLayout> instance = SwipeMenuLayout.Companion.getLastInstance();
            if (instance == null || (instance == null && instance.get() != null && instance.get().isClosed())) {
                mItemTouchHelperGestureListener.mShouldReactToLongPress = true;
            } else {
                mItemTouchHelperGestureListener.mShouldReactToLongPress = false;
            }
     ...
     */
    public MenuItemTouchHelper(@NonNull Callback callback) {
        mCallback = callback;
    }
     ...
     * {@link MenuItemTouchHelper}.
     */
    public interface ViewDropHandler {

        /**
         * Called by the {@link MenuItemTouchHelper} after a View is dropped over another View.
         * <p>
    ...
    public abstract static class Callback {
         ...
         *                    it is cleared.
         * @param actionState One of {@link MenuItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link MenuItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link MenuItemTouchHelper#ACTION_STATE_DRAG}.
